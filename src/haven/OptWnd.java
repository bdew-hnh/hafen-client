...
public class OptWnd extends Window {
	...
	y += 20;
	iface.add(Config.fastFlowerMenus.makeCheckBox(), new Coord(0, y));

	y += 20;
	iface.add(Config.deactivateAttackInCombat.makeCheckBox(), new Coord(0, y));

	y += 20;
	iface.add(Config.logBarChanges.makeCheckBox(), new Coord(0, y));

	y += 20;
	iface.add(Config.showHorizon.makeCheckBox(), new Coord(0, y));
